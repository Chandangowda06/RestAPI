...
from user_app.api.views import LeaveApplicationReadonly, EventViewSet, LeaveApplicationViewSet, RolesViewSet, UserByUsernameView, ProfileByUsernameView, PasswordConfirmAV, PasswordResetAV, UserViewSet, ProfileViewSet, CollegeViewSet, DepartmentViewSet, GroupList, CustomObtainAuthToken, LogoutView
