...
class LeaveApplication(models.Model):
    ...
    LEAVE_TYPES = (
        ...
        ('Paternity leaves', 'Paternity leaves'),
    ...
    approved_hod = models.BooleanField(null=True, blank= True, default=None)
    approved_AO = models.BooleanField(null=True, blank= True, default=None)
    approved_principal = models.BooleanField(null=True, blank= True, default=None)
    approved_director = models.BooleanField(null=True, blank= True, default=None)
    approved_ceo = models.BooleanField(null=True, blank= True, default=None)
    letter = models.FileField(default=None, blank=True)
    # Timestamps
